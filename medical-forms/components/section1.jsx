...
const section1 = () => {
  ...
  const handleCheckboxChange = (e) => {
    ...
    if (e.target.checked) {
      ...
      // Clear residenceData when checkbox is unchecked
      setResidenceData({
        addressLine1R: '',
        addressLine2R: '',
        cityR: '',
          ...
          <div className='my-11'>
            ...
            <div className='flex flex-col gap-16 text-center justify-center sm:gap-10'>
              ...
              <div className='flex flex-row gap-9 justify-center text-center mt-6'>
                ...
                <div className='text-center'>
                  <Link href="\section2" className='border p-2 hover:bg-slate-400 text-black transition-all ease-in cursor-pointer rounded-md'>
