      ...
      <div className='mx-24 mt-11'>
        ...
        <div className='my-11'>
          ...
          <div className='my-7 flex flex-row ml-3 items-center'>
            <input type="checkbox" id="sameAsMailingAddress" className="h-4 w-4 mr-2 cursor-pointer" />
            <label htmlFor="sameAsMailingAddress" className="text-sm items-center justify-center">Same as mailing address</label>
          </div>
